...
<center>![](http://i.imgur.com/umjwhyr.png)</center>
...
<center>$$h(x)=h_\theta(x)=\sum_{i=0}^n\theta_ix_i=\vec \theta^T\vec x​$$</center>
...
<center>$$J(\theta)=\frac12\sum_{i=1}^m(h_\theta(\vec x^{(i)})-y^{(i)})^2$$</center>
